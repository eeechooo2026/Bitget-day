...
def main():
    ...
    print(f"🚀 开始第78个工作流扫描（1小时级别：上根震荡 + 上上根不震荡 + 按振幅×杠杆/100排序）")
    ...
    print(f"   上上上根: {target_time3} - {(ts_to_beijing(prev3_ts)+timedelta(hours=1)).strftime('%H:%M')}")

...
def main():
    ...
    print(f"🚀 开始第93个工作流扫描（4小时级别：上根KDJ多头 + 上上根非多头 + 上根震荡 + 上根收阳 + 按振幅排序（不含杠杆））")
    ...
    msg_lines = [
        f"📊 Bitget 4小时级别KDJ多头+震荡+收阳扫描（第93个工作流）",
    ...
    if top:
        ...
        msg_lines.append("💡 解读：KDJ多头+震荡+收阳，按振幅排序（不含杠杆）")

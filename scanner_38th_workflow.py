...
def main():
    ...
    print(f"🚀 开始第38个工作流扫描（4小时级别：上根收盘<MA20 + 上根震荡 + 上上根收阴 + 按上上根振幅排序）")
    ...
    msg_lines = [
        f"📊 Bitget 4小时级别（上根<MA20 + 震荡 + 上上根收阴）扫描（第38个工作流）",
    ...
    if top:
        ...
        msg_lines.append("💡 解读：上根在MA20下方且在上上根区间内震荡，上上根收阴，按上上根振幅排序")
